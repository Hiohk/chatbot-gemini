  ...
  <header class="py-12 px-4 sm:px-6 lg:px-8">
    <div class="relative mx-auto max-w-[37.5rem] pt-20 text-center pb-20">
      <div class="flex items-center justify-center space-x-3">
        <img loading="lazy" src="/logo.svg" alt="chatbot" class="h-20 w-20" />
        <h1 class="text-4xl font-extrabold tracking-tight text-slate-700 sm:text-5xl">
          Chatbot-Gemini
        </h1>
      </div>
      <p class="mt-4 text-base leading-7 text-slate-600">
        Chatbot-Gemini is a chat module made with Nuxt, Vue, and
        Tailwindcss. In addition, I recommend a personal knowledge site:
        <a href="https://hiohk.github.io/knowledge-graph/" target="_blank" rel="knowledge" style="color: #0EA5E9">Knowledge Graph</a>,
        here contains the front-end back-end knowledge.
      </p>
    </div>
  </header>
</template>
